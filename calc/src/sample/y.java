...
public class y extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        Off.setTextFill(Paint.valueOf("silver"));
        Off.setBackground(button_light_background);
        ...
        Off.setMaxSize(Double.MAX_VALUE,Double.MAX_VALUE);
        ...
        //Screen
        Button screen=new Button("2+5-sin(59)-527");
        ...
        //Finishing
        pane.getChildren().addAll(screen,exp,Off,sin_i,cos_i,tan_i,e,pi,sin,cos,tan,seven,eight,nine,ln,lg,four,
